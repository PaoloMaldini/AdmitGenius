...
import com.admitgenius.service.EssayPolishService;
...
public class EssayPolishController {
     ...
     */
    @PostMapping("/{essayId}")
    public ResponseEntity<EssayDTO> polishExistingEssay(@PathVariable Long essayId,
            @RequestBody EssayPolishDTO polishDTO) {
