...
import com.admitgenius.exception.UnauthorizedAccessException;
...
public class SchoolServiceImpl implements SchoolService {
    ...
    public void deleteSchool(Long id, Long userId) {
        ...
        // Consider handling related SchoolPrograms (e.g., cascade delete or
        // disassociate)
        // For now, let's assume cascade delete is configured at DB or JPA level, or
    ...
    public SchoolProgramDTO updateSchoolProgram(Long programId, SchoolProgramDTO programDTO, Long userId) {
        ...
        // If schoolId is provided and different, update the association (optional, can
        // be complex)
        // For simplicity, we assume program's school doesn't change, or it's handled by
    ...
    private SchoolDTO convertToSchoolDTO(School school) {
        ...
        // Consider adding a list of SchoolProgramDTOs here if needed for detailed
        // school view
        return dto;
    }
