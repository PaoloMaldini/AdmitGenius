...
import com.admitgenius.repository.*;
...
public class DataInitializer implements ApplicationRunner {
        ...
        public void run(ApplicationArguments args) throws Exception {
                ...
                // 如果数据库中没有学校数据，则创建示例数据
                if (schoolRepository.count() == 0) {
                        logger.info("数据库中没有学校数据，创建示例数据");
                        initializeSampleSchools();
                } else {
                        logger.info("学校数据已存在，跳过示例数据创建");
                }
        ...
        private void initializeDefaultAdmin() {
                ...
                if (!userRepository.existsByEmail("admin@admitgenius.com")) {
                        ...
                        logger.info("默认管理员账户已创建: admin@admitgenius.com / admin123");
                } else {
        ...
        private void initializeSampleSchools() {
                ...
                logger.info("示例学校数据初始化完成，共创建 5 所学校");
        }
        ...
        private void createProgram(School school, String name, SchoolProgram.DegreeLevel degreeLevel,
                ...
                program.setTuitionFee(String.format("$%.2f", tuitionFee));
